...
public interface AnswerJpaRepository extends JpaRepository<Answer, Long> {
    ...
    @Query("SELECT NEW com.nighthawk.spring_portfolio.mvc.rpg.answer.LeaderboardDto(p.user_id, SUM(a.chatScore)) FROM Answer a JOIN a.player p GROUP BY p.user_id ORDER BY SUM(a.chatScore) DESC")
